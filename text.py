...
def appStarted(app):
    ...
    Great Vibes'''
    app.timerDelay = 1000
    app.strList = app.strList.splitlines()

def timerFired(app):
    app.curIndex += 1
    print(app.strList[app.curIndex])

def redrawAll(app, canvas):
    if (app.strList[app.curIndex].count(" ") <= 4):
        canvas.create_text(100, 100, font = f"{app.strList[app.curIndex]} 10", text = "sldfkjslkf")
